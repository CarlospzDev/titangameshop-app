<template>
    <div class="fixed top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] bg-white p-[30px] w-[35%]" v-if="game">
        <!-- contenedor del modal  -->
        <div
            class="flex justify-between text-[25px] gap-[40px] text-center font-bold border-b-slate-700 border-b-[0.5px] mb-[20px]">
            <!-- header del modal -->
            <h2 class="">Editar Juego</h2>
        ...
        <div class="pt-[20px]">
            <!-- formulario -->
            <form class="flex flex-col" @submit="updateGame">
                ...
                <div class="flex flex-wrap gap-[10px]">
                    ...
                    <div class="flex flex-col w-[49.1%] gap-[10px]">
                        <!-- <div class="flex flex-col w-full gap-[10px] mb-[10px]">
                            <div class="w-full">
                                <input type="text" required class="border-b-slate-700 border-b-[2.5px] w-full p-[5px]"
                                    id="name" :value="game.name">
                            </div>
                            <div class="w-full">
                                <input type="number" required class="border-b-slate-700 border-b-[2.5px] w-full p-[5px]"
                                    id="price" placeholder="Precio" :value="game.price">

                            </div>
                        </div> -->
                        <div class="flex flex-col w-full gap-[10px] mb-[10px]">
                            <div class="w-full h-[40px] relative overflow-hidden text-[15px]">
                                <input type="text" required class="fields" id="name" autocomplete="off" :value="game.name">
                                <label class="lbl-nombre">
                                    <span class="text-nomb text-gray-500">Nombre Del Juego</span>
                                </label>
                            </div>
                            <div class="w-full h-[40px] relative overflow-hidden text-[15px]">
                                <input type="number" required class="fields" id="price" autocomplete="off" :value="game.price">
                                <label class="lbl-nombre">
                        ...
                        <div class="w-full">
                            ...
                            <div class="pt-[25px]">
                                ...
                                <textarea name="" id="description" required
                                    ...
                                    placeholder="Ingrese una descripción" maxlength="400"
                    ...
                    <div class="flex flex-col gap-[10px] w-[49.1%]">
                        ...
                        <div class="w-full flex gap-2 items-end h-full">
                            ...
                            <img class="w-[82%] h-[100%]" id="image" alt=""
                                :src="uri_api + '/game/get-game-image/' + this.$route.params.id">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async updateGame(e) {
            ...
            const res = await axios.put(environ.URL_API + '/game/update/' + this.$route.params.id, formData, {
            ...
            if (res) {
                this.$swal.fire({
                    position: 'center',
                    icon: 'success',
                    title: 'Se ha actualizado el juego',
